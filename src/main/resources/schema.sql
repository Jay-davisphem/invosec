CREATE SCHEMA IF NOT EXISTS invosec;
SET NAME = 'UTF8MB4';
...
CREATE TABLE AccountVerifications(
    ...
    FOREIGN KEY (user_id) REFERENCES Users (id) ON DELETE CASCADE ON UPDATE CASCADE,
    CONSTRAINT UQ_AccountVerications_User_Id UNIQUE (user_id),
    CONSTRAINT UQ_AccountVerications_Url UNIQUE (url)
);
...
CREATE TABLE ResetPasswordVerifications(
    ...
    user_id BIGINT UNSIGNED NOT NULL,
    url VARCHAR(255) DEFAULT NOT NULL,
    expires_at DATETIME NOT NULL CURRENT_TIMESTAMP + INTERVAL 24 HOUR,
    FOREIGN KEY (user_id) REFERENCES Users (id) ON DELETE CASCADE ON UPDATE CASCADE,
